...
public class MapGenVillageCC extends MapGenVillage {
   ...
   /**
    ...
    protected boolean canSpawnStructureAtCoords(int par1, int par2)
    {
        ...
        if (k == i1 && l == j1) {
            boolean flag = this.worldObj.getBiomeProvider().areBiomesViable(k * 16 + 8, l * 16 + 8, 0, this.VILLAGE_SPAWN_BIOMES);
    ...
    public static class Start extends StructureStart
        {
            ...
            public Start(World par1World, Random par2Random, int par3, int par4, int par5)
            {
                ...
                StructureVillagePieces.Start start = new StructureVillagePieces.Start(par1World.getBiomeProvider(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, list, par5);
                this.components.add(start);
                start.buildComponent(start, this.components, par2Random);
                List list1 = start.pendingHouses;//start.field_74930_j;
                List list2 = start.pendingRoads;//.field_74932_i;
                int l;
